...
class RangedStatsTest {
    ...
    @Test def void testToString() {
        ...
        testRangedStats = new RangedStats(rangedAttackpower: 0,
            rangedDamage: 0, rangedDps: 0, rangedSpeed: 0,
